...
# producto
INSERT INTO `tienda`.`producto` (`idProducto`,`nombre`, `idCategoria`, `precioUnitario`) VALUES (1, 'Avena', '2', '2');
INSERT INTO `tienda`.`producto` (`idProducto`,`nombre`, `idCategoria`, `precioUnitario`) VALUES (2, 'Queso', '4', '6');
INSERT INTO `tienda`.`producto` (`idProducto`,`nombre`, `idCategoria`, `precioUnitario`) VALUES (3, 'Kiwi', '5', '0.50');
INSERT INTO `tienda`.`producto` (`idProducto`,`nombre`, `idCategoria`, `precioUnitario`) VALUES (4, 'Coco', '2', '2.3');
INSERT INTO `tienda`.`producto` (`idProducto`,`nombre`, `idCategoria`, `precioUnitario`) VALUES (5, 'Leche', '4', '2.2');
INSERT INTO `tienda`.`producto` (`idProducto`,`nombre`, `idCategoria`, `precioUnitario`) VALUES (6, 'Agua', '3', '1.5');
...
INSERT INTO `tienda`.`producto` (`nombre`, `idCategoria`, `precioUnitario`) VALUES ('Jugo de Pera', '4', '1.7');
